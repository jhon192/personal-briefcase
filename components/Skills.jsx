      ...
      <div className="bg-blue-special m-10 rounded-2xl">
        <div className="flex justify-evenly items-center flex-wrap">
          <div>
            ...
            <h1 className="md:mx-10 mx-2 md:text-5xl text-2xl">Habilidades</h1>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 md:m-10 rounded-xl shadow-lg bg-white md:w-3/6 w-2/3">
